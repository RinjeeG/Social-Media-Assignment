...
urlpatterns = [
    ...
    path('api/signup/', api_views.signup, name='api-signup'),
    path('api/profile/', api_views.profile_detail, name='profile-detail'),
    path('api/profile/update/', api_views.profile_update, name='profile-update'),
